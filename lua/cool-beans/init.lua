...
local function get_groups()
    ...
    local groups = {
        ...
        CBAqua = { fg = colors.aqua },
        CBBlue = { fg = colors.blue },
        CBMagenta = { fg = colors.purple },
        ...
        CBAquaBold = { fg = colors.aqua, bold = config.bold },
        CBBlueBold = { fg = colors.blue, bold = config.bold },
        CBMagentaBold = { fg = colors.purple, bold = config.bold },
        ...
        CBAquaSign = { fg = colors.aqua, bg = defaultBg1, reverse = config.invert_signs },
        CBBlueSign = { fg = colors.blue, bg = defaultBg1, reverse = config.invert_signs },
        CBMagentaSign = { fg = colors.purple, bg = defaultBg1, reverse = config.invert_signs },
        ...
        CBAquaUnderline = { undercurl = config.undercurl, sp = colors.aqua },
        CBBlueUnderline = { undercurl = config.undercurl, sp = colors.blue },
        CBMagentaUnderline = { undercurl = config.undercurl, sp = colors.purple },
        ...
        Statement = { link = "CBRed" },
        Conditional = { link = "CBRed" },
        Repeat = { link = "CBRed" },
        Label = { link = "CBRed" },
        Exception = { link = "CBRed" },
        Operator = { fg = colors.orange, italic = config.italic.operators },
        Keyword = { link = "CBRed" },
        Identifier = { link = "CBBlue" },
        Function = { link = "CBGreenBold" },
        PreProc = { link = "CBCyan" },
        Include = { link = "CBCyan" },
        Define = { link = "CBCyan" },
        Macro = { link = "CBCyan" },
        PreCondit = { link = "CBCyan" },
        Constant = { link = "CBMagenta" },
        Character = { link = "CBMagenta" },
        String = { fg = colors.green, italic = config.italic.strings },
        Boolean = { link = "CBMagenta" },
        Number = { link = "CBMagenta" },
        Float = { link = "CBMagenta" },
        Type = { link = "CBYellow" },
        StorageClass = { link = "CBOrange" },
        Structure = { link = "CBCyan" },
        Typedef = { link = "CBYellow" },
        ...
        SpellRare = { link = "CBMagentaUnderline" },
        Whitespace = { fg = colors.bg2 },
        Delimiter = { link = "CBOrange" },
        ...
        TelescopeSelectionCaret = { link = "CBRed" },
        TelescopeMultiSelection = { link = "CBGray" },
        TelescopeBorder = { link = "TelescopeNormal" },
        TelescopePromptBorder = { link = "TelescopeNormal" },
        TelescopeResultsBorder = { link = "TelescopeNormal" },
        TelescopePreviewBorder = { link = "TelescopeNormal" },
        TelescopeMatching = { link = "CBOrange" },
        TelescopePromptPrefix = { link = "CBRed" },
